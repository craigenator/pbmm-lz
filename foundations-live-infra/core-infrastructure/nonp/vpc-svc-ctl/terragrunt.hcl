...
locals {
  vpcSvcCtl = yamldecode(file("${get_terragrunt_dir()}/../../../config/nonp-vpc-svc-ctl.yaml"))
...
inputs = {
  ...
  regular_service_perimeter = local.vpcSvcCtl.nonpVpcSvcCtl.regular_service_perimeter
  bridge_service_perimeter  = local.vpcSvcCtl.nonpVpcSvcCtl.bridge_service_perimeter
