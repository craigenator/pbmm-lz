...
module "export_asset_inventory_cf" {
  source = "git@github.com:GovAlta/terraform-gcp-goa-naming.git//modules/gcp/cloud_function"
...
module "guardrails_container_build_pipeline_name" {
  source = "git@github.com:GovAlta/terraform-gcp-goa-naming.git//modules/gcp/cloudbuild_trigger"
...
module "guardrails_scheduler_name" {
  source = "git@github.com:GovAlta/terraform-gcp-goa-naming.git//modules/gcp/cloud_scheduler_job"
...
module "guardrails_service_account_name" {
  source = "git@github.com:GovAlta/terraform-gcp-goa-naming.git//modules/gcp/service_account"
...
module "guardrails_source_repo_name" {
  source = "git@github.com:GovAlta/terraform-gcp-goa-naming.git//modules/gcp/generic_resource_name"
...
module "guardrails_policies_container_name" {
  source = "git@github.com:GovAlta/terraform-gcp-goa-naming.git//modules/gcp/container_registry_image"
