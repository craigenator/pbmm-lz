...
variable "yaml_config_bucket" {
  ...
  description = "Map with config bucket params"
}

variable "yaml_config_bucket_writers" {
  type        = list(string)
  description = "list of Groups/SA/Users in the form of user:me@domain.com"
  default     = []
}
