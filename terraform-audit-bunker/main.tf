...
resource "google_logging_billing_account_sink" "goa-billing-sink" {
  name            = "goabillingsink" #var.sink_name 
...
resource "google_storage_bucket" "log-bucket" {
  name                           = "goa-billing-bucket" #var.bucket_name 
...
resource "google_project_iam_binding" "log-writer" {
  ...
  members = [
    google_logging_billing_account_sink.goa-billing-sink.writer_identity,
  ]
}
